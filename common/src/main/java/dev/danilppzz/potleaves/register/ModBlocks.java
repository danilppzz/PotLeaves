...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(PotLeaves.MOD_ID, Registry.BLOCK_REGISTRY);

    // Here goes the mod blocks
    public static final RegistrySupplier<WoodenSlimPot> SLIM_WOODEN_POT = registerBlock("slim_wooden_pot",
            () -> new WoodenSlimPot(BlockBehaviour.Properties.copy(Blocks.GLASS).sound(SoundType.BAMBOO)));

    public static final RegistrySupplier<WoodenBox> WOODEN_BOX = registerBlock("wooden_box",
            () -> new WoodenBox(BlockBehaviour.Properties.copy(Blocks.GLASS).sound(SoundType.BAMBOO)));

    // Cactus
    public static final RegistrySupplier<WoodenPot> SLIM_CACTUS_POT = registerBlock("slim_cactus_pot",
            () -> new WoodenPot(BlockBehaviour.Properties.copy(Blocks.GLASS).sound(SoundType.BAMBOO)));
    ...
    public static final RegistrySupplier<LargeWoodenPot> LARGE_WOODEN_POT = registerBlock("large_wooden_pot",
            () -> new LargeWoodenPot(BlockBehaviour.Properties.copy(Blocks.GLASS).sound(SoundType.BAMBOO)));
    ...
    private static <T extends Block> void registerBlockItem(String name, RegistrySupplier<T> block) {
        ModItems.ITEMS.register(name, () -> new BlockItem(block.get(), new Item.Properties().tab(ModTabs.POT_LEAVES)));
    }
}
